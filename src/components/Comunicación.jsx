  ...
  return (
    <div class="container flex flex-col">
      <div class="flex flex-col lg:flex-row w-full mb-10">
        <h1 class="sm:text-3xl text-36 w-full flex items-center justify-center font-medium title-font text-gray-900 lg:w-1/3 lg:mb-0 mb-4">Comunicación <br /> Anunciando el Evangelio</h1>
