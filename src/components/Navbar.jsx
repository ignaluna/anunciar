...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className={`logo transition-all duration-700  ${scrolled ? "scale-100" : ""}`} id="logo">
        <Image
          src="https://res.cloudinary.com/dvh8hozns/image/upload/v1688157403/Anunciar/qpi5qareodaxmmehor3u.png"
          alt="Logo"
          height={scrolled ? 100 : 150} // Cambia el tamaño de acuerdo con el estado de "scrolled"
          width={scrolled ? 100 : 150}  // Cambia el tamaño de acuerdo con el estado de "scrolled"
        />
      </div>
    </nav>
  );
